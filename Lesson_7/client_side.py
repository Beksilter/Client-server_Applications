...
from log.client_log_settings import LOGGER as CLIENT_LOGGER  # Инициализация клиентского логера
...
def create_new_presence(account_name='Guest'):
    ...
    """
    # {'action': 'presence', 'time': 1473260472.166031, 'user': {'account_name': 'Guest'}}
    out = {
        ACTION: PRESENCE,
        TIME: time.time(),
        USER: {
